-- Re-assert group functions WITH system messages (runs last, so it wins
-- regardless of the order earlier migrations were applied/re-run in).
...
-- ── update_group: rename / avatar change emit system messages ────────────────
...
-- ── create_group: "created group" system message ─────────────────────────────
...
-- ── add_group_members: "added X" system message per added member ─────────────
